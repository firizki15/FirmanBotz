...
${chatnye}
`
let ppp = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/a2ae6cbfa40f6eeea0cf1.jpg')
let hasil = `https://api.lolhuman.xyz/api/welcomeimage?apikey=IchanZX&img=${ppp}&text=DAFTAR SUKSES ${name}`
await conn.sendMessage(m.chat, { image: { url: hasil }, caption: cap }, m)
