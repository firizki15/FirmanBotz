...
let chann = `Hai ${name}\n\n*${global.author}* adalah bot Rpg PlayGround's yg membantu membuat sticker, dan membuat kalian bermain dengan senang-senang.\n\nBerikut ini list *OPENAI* yang tersedia:\n\n• .ai\n• .aiturbo\n• .imgai\n\n2023 © ${global.nameown}.`
let menu = [
    '🗿'
    ]
...
conn.sendFile(m.chat, thumb, 'menu.jpg', `${chann}`, m)
